...
Per [ADR-0001](./0001-empirically-derived-schema-via-corpus-survey.md). Second kind surveyed (after `skill`, [ADR-0005](./0005-skill-schema.md)). Agents are markdown-with-frontmatter files that become a subagent's system prompt when invoked. Both Claude Code and Gemini CLI document agent-kind support; real-world adoption is heavily Claude-skewed.
