...
- [Hook Schema](schemas/hook.md)
- [Mcp-Server Schema](schemas/mcp-server.md)
- [Memory Schema](schemas/memory.md)
- [Rule Schema](schemas/rule.md)
- [Skill Schema](schemas/skill.md)
